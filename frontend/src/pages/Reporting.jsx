...
export const Reporting = () => {
  ...
  const generatePDFReport = async () => {
    try {
      ...
      // Sevkiyat detay listesi (İrsaliye dahil)
      doc.setFontSize(14);
      doc.setFont('helvetica', 'bold');
      ...
      // Stok detayları (Eğer API'den geliyorsa)
      ...
      // Hammadde başlangıç ve bitiş durumu (Eğer API'den geliyorsa)
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        if (i === 1) {
          // Kapak sayfasında sayfa numarası yok
          continue;
        }
